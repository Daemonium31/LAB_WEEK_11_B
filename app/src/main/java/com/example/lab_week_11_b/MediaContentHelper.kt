...
// Kelas helper untuk menghasilkan URI dan ContentValues untuk MediaStore
class MediaContentHelper {

    // Mendapatkan URI untuk menyimpan gambar dan video di MediaStore
    // URI akan berbeda untuk Android 10 ke atas
    ...
    // Menghasilkan ContentValues untuk menyimpan gambar dan video di MediaStore
    // Ini berisi nama, path relatif, dan tipe MIME file
